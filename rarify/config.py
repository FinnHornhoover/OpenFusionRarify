...
class ItemConfig:
    ...
    def from_dict(
        ...
        if not any_exists:
            logging.warn(
                "No valid requirements for item: %s, skipping ...", data_sanitized
            )
            return None
    ...
    def fix_item(
        ...
        if item_tuple_valid and found_tuple_valid:
            if item_tuple != found_tuple:
                logging.warn(
                    "%s refers to %s but %s was specified, using %s ...",
                    item_name,
                    found_tuple,
                    item_tuple,
                    item_tuple,
            ...
            logging.warn(
                "Item could not be identified: %s, skipping ...", data_sanitized
            )
            return None
        ...
        **kwargs,
        ...
        for k, v in value.items():
            try:
                ...
                if len(mob_ids) > 1:
                    logging.warn(
                        "Mob name %s refers to mobs %s, using %s ...",
                        k,
                        mob_ids,
                        mob_id,
                    )
            ...
            if v_fixed is None:
                logging.warn("Given value %s for mob %s will be skipped ...", v, mob_id)
                continue
    ...
    def fix_event_value_till_item(
        ...
        **kwargs,
        ...
        for k, v in value.items():
            ...
            if v_fixed is None:
                logging.warn(
                    "Given value %s for event %s will be skipped ...", v, event_id
                )
                continue
    ...
    def fix_kills_till_item(
        ...
        **kwargs,
        ...
        if value_fixed is None:
            logging.warn("Given value %s for item %s will be skipped ...", value, name)
        return value_fixed
    ...
    def fix_crates_till_item_per_crate_type(
        ...
        **kwargs,
        ...
        for k, v in value.items():
            ...
            if v_fixed is None:
                logging.warn(
                    "Given value %s for %s CRATE will be skipped ...", v, crate_name
                )
                continue
        ...
        **kwargs,
        ...
        for k, v in value.items():
            ...
            if not isinstance(v, dict):
                logging.warn(
                    "Value %s should specify CRATE types for mob %s, skipping ...", v, k
                )
                continue
    ...
    def fix_crates_till_item_per_crate_type_and_mob(
        ...
        **kwargs,
        ...
        for k, v in value.items():
            ...
            if not isinstance(v, dict):
                logging.warn(
                    "Value %s should specify mobs for CRATE type %s, skipping ...", v, k
                )
                continue
            ...
            if not inner_map:
                logging.warn("No valid requirements for CRATE type %s, skipping ...", k)
                continue
    ...
    def fix_race_crates_till_item(
        ...
        **kwargs,
        ...
        for k, v in value.items():
            ...
            if not isinstance(v, dict):
                logging.warn(
                    "Value %s should specify mobs for IZ %s, skipping ...", v, k
                )
                continue
    ...
    def fix_mission_crates_till_item(
        ...
        **kwargs,
        ...
        for k, v in value.items():
            ...
            if (
                level != OTHER_STANDARD_ID
                and level not in knowledge_base.mission_level_crate_id_map
            ):
            ...
            v_fixed = cls.fix_number(v)
            if v_fixed is None:
                logging.warn("Given value %s for level %s will be skipped ...", v, k)
                continue
    ...
    def fix_egger_eggs_till_item(
        ...
        **kwargs,
        ...
        for k, v in value.items():
            ...
            if not isinstance(v, dict):
                logging.warn(
                    "Value %s should specify mobs for zone %s, skipping ...", v, k
                )
                continue
        ...
        **kwargs,
        ...
        for k, v in value.items():
            try:
                ...
                if k_sanitized in OTHER_KEYWORDS:
                    logging.warn(
                        "Keyword %s is not allowed for named CRATEs, skipping ...", k
                    )
                    continue
                ...
                if len(crate_ids) > 1:
                    logging.warn(
                        "CRATE name %s refers to CRATEs %s, using %s ...",
                        k,
                        crate_ids,
                        crate_id,
                    )
            ...
            if v_fixed is None:
                logging.warn(
                    "Given value %s for CRATE ID %s will be skipped ...", v, crate_id
                )
                continue
